...
@Component({
  ...
  template:`
    <header><p class="eyebrow">EVERYDAY ESSENTIALS</p><h1>Supermarket expenses</h1><p>Track grocery runs and everyday household purchases by shop and category.</p></header>
